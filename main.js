...
let contractAddress = "0x5A663D18dA35e54D5dA559b74C60A31ff02542Fd";
let contractAbi = [
    {
        "inputs": [
          {
...
async function connectMetamask() {
    if (typeof window.ethereum !== 'undefined') {
        try {
            ...
            document.getElementById('metamasknotification').innerText = 'MetaMask is connected';
        } catch (error) {
            console.error('User rejected the request');
            document.getElementById('metamasknotification').innerText = 'User rejected the request';
        }
    } else {
        document.getElementById('metamasknotification').innerText = 'MetaMask is not installed';
    }
}
